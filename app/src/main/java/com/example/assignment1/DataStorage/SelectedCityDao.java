...
public class SelectedCityDao implements ISelectedCityDao {
    ...
    public boolean deleteCity(String name)
    {
        ...
        SelectedCityOpenHelper cityOpenHelper = new SelectedCityOpenHelper(context);
        SQLiteDatabase db = cityOpenHelper.getWritableDatabase();


        return db.delete("SelectedCities", "Name" + "=\"" + name + "\"", null) > 0;
    }
